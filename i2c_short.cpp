/* =========================================================================
This code was compiled from various sources and libraries to run the 
heart rate monitor. It reads and writes to the device great, but the LEDs
don't function.
Written by James Ligon
 ========================================================================= */
